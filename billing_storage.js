(function () {
    const LS_BILLING = "dolfin_batch_invoices";
    const LS_RETURN = "dolfin_return_list";
    const LS_CREDIT_MEMO = "dolfin_credit_memo_list";
    ...
    function getCreditMemos() {
        ...
        const derived = getReturns()
            ...
            .map((item, index) => ({
                ...
                createdBy: item.approvalInfo?.approvedBy || "Distributor Finance",
