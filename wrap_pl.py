    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid px-3">
            <a class="navbar-brand fw-bold" href="admin_dashboard.html">
                <i class="bi bi-shield-lock-fill me-2"></i>Dolfin Admin
            </a>
...
wrap_file(r'd:\STEM\Dolfin2\Dolfin\Dolfin\HTML\src\main\resources\static\admin_PLList.html', 'Price List Management', 'PriceList')
wrap_file(r'd:\STEM\Dolfin2\Dolfin\Dolfin\HTML\src\main\resources\static\admin_PLadd.html', 'Add Price List', 'PriceListAdd')
